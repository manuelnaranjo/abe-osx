...
match=''
test_parser $BASH_LINENO user "${in}" "${match}" "${errmatch}"
match='git'
test_parser $BASH_LINENO service "${in}" "${match}" "${errmatch}"
match='repo.git'
test_parser $BASH_LINENO repo "${in}" "${match}" "${errmatch}"
match='repo'
test_parser $BASH_LINENO tool "${in}" "${match}" "${errmatch}"
match='git://address.com/directory/repo.git'
test_parser $BASH_LINENO url "${in}" "${match}" "${errmatch}"
match=''
test_parser $BASH_LINENO revision "${in}" "${match}" "${errmatch}"
